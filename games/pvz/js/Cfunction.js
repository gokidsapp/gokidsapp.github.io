var $User = (function () {
    ...
    LoadReady: function (f) {
      ...
      if (f.CenterContent) {
        ...
        $("dAdFlash").innerHTML =
          ...
          Math.random() +
          '"></iframe><br><div style="font-family:arial,sans-serif;font-size:11px;position:absolute;left:300px;width:200px">广告时间</div>';
  ...
  InitGame = function () {
    ...
    !$("dText1") &&
      a.insertBefore(
        NewEle("dText1", "div", 0, { innerHTML: "" }, 0),
        a.firstChild
      );
    $("IF2").src =
      b[c.DataInx][1] +
      "asp/ChatSend.asp" +
      { 0: "", 1: "?C=5000", 255: "?C=0" }[$User.Visitor.UserAuthority];
    $("ChatView").src = b[c.DataInx][1] + "asp/ViewChat.asp";
    e.innerHTML =
      Number(c.SpeedInx) + 1 + "号服<br>" + (Number(c.DataInx) + 1) + "号服";
    LoadLvl();
  },
  LoadLvl = function (e, c) {
    ...
    oS.CenterContent &&
      ((e == 0 && b) || e != 0) &&
      ((oS.DisplayAD = true), SetBlock($("dAdFlash"), $("dAD2")));
    SetBlock($("dLvlLink"));
    e = e || 0;
    ...
    oSym.Init(
      function (g, f) {
        ...
        NewEle(
          ...
          "script",
          0,
          { src: "level/" + (oS.Lvl = g) + ".js", type: "text/javascript" },
...
($SSml = function (d, c, a) {
  ...
  (ViewChat = function (a) {
    a.value == "显示聊天"
      ? (SetBlock($("IF2"), $("dChatView")), (a.value = "关闭聊天"))
      : (SetNone($("IF2"), $("dChatView")), (a.value = "显示聊天"));
  });

function CMain(oData) {
  ...
  this._loadImages = function () {
    ...
    s_oSpriteLibrary.addSprite(
      "but_leaderboard",
      "./sprites/leaderBoar_Btn.png"
    );
    s_oSpriteLibrary.addSprite(
      "but_submit_score",
      "./sprites/submit_score.png"
    );
